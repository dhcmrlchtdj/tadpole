...
let scan (src : string) : WatToken.t list =
    ...
    and scan_string (acc : char list) = function
        ...
        | '\\' :: 'u' :: t ->
            ...
            (match scan_hexdigit [] t with
                ...
                | _ -> failwith "[scan_string \\u{hexnum}]")
    ...
    and scan_num = function _ -> failwith "TODO"
    and scan_hexnum = function _ -> failwith "TODO"
    ...
    and scan_token = function
        ...
        | '"' :: t -> scan_string [] t
        | 'a' .. 'z' :: _ as t -> scan_keyword [] t
        | '$' :: _ as t -> scan_id [] t
        | '0' :: 'x' :: _ as t -> scan_hexnum t
