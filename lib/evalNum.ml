...
let unop = function
  ...
  | (TI32, I_POPCNT, I32 i) -> Some (I32 (Nint32.UnOp.popcnt i))
  (* TI64 *)
  | (TI64, I_CLZ, I64 i) -> Some (I64 (Nint64.UnOp.clz i))
  | (TI64, I_CTZ, I64 i) -> Some (I64 (Nint64.UnOp.ctz i))
  | (TI64, I_POPCNT, I64 i) -> Some (I64 (Nint64.UnOp.popcnt i))
  (* TF32 *)
...
let cvtop = function
  ...
  | (TI32, CVT_TRUNC_S, TF32, F32 x) -> Some (I32 (Nint32.CvtOp.trunc_s_f32 x))
  | (TI32, CVT_TRUNC_S, TF64, F64 x) -> Some (I32 (Nint32.CvtOp.trunc_s_f64 x))
  | (TI32, CVT_TRUNC_U, TF32, F32 x) -> Some (I32 (Nint32.CvtOp.trunc_u_f32 x))
  | (TI32, CVT_TRUNC_U, TF64, F64 x) -> Some (I32 (Nint32.CvtOp.trunc_u_f64 x))
  ...
  | (TI64, CVT_TRUNC_U, TF64, F64 x) -> Some (I64 (Nint64.CvtOp.trunc_u_f64 x))
  ...
  | (TF32, CVT_DEMOTE, TF64, F64 x) -> Some (F32 (Nfloat32.CvtOp.demote_f64 x))
